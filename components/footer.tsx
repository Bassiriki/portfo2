...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-primary to-secondary text-primary-foreground py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gradient-to-br from-accent to-accent/80 rounded-2xl flex items-center justify-center shadow-xl">
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                className="w-10 h-10 bg-accent/20 rounded-xl flex items-center justify-center hover:bg-accent hover:scale-110 transition-all duration-300 shadow-lg"
                aria-label="Email"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-primary-foreground/80">
              ...
              <li>
                <a href="#livres" className="hover:text-accent transition-colors">
                  Mes Livres
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-primary-foreground/90">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">Bassiriki@gmail.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-accent" />
                <span className="text-lg">75009032</span>
              </div>
              <p className="text-accent font-medium">Réponse sous 24h</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center">
          <p className="text-primary-foreground/70 text-lg">
            © {currentYear} Onohilosophe - Seydou KONE. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
